...
public class Actividad {
    ...
    private LocalDate fechaHora_actividad;
    ...
    public Actividad(int id_actividad, String tipo_actividad, String descripcion_actividad, LocalDate fechaHora_actividad, Usuario id_usuario) {
    ...
    public LocalDate getFechaHora_actividad() {
        return fechaHora_actividad;
    }

    public void setFechaHora_actividad(LocalDate fechaHora_actividad) {
        this.fechaHora_actividad = fechaHora_actividad;
    }
